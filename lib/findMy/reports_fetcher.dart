...
class ReportsFetcher {
  ...
  static Future<List> fetchLocationReports(String hashedAdvertisementKey, String seemooEndpoint) async {
    final response = await http.post(Uri.parse(seemooEndpoint),
